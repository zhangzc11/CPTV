...
Double_t Z_WidthOfBin = 3600.0;//86400.0/24.00;// 1 sidereal day = 86164.09 seconds
Double_t Z_StartTime = 1324684800.0000;
Double_t Z_EndTime = 1385769600.00000;
Int_t    Z_NumOfBin = 16968;//(Z_EndTime - Z_StartTime)/Z_WidthOfBin;// = 16968  -->  16968
Int_t    Z_Site ;
Int_t    Z_Bin;
...
Double_t Z_VT1[3][16968];//={0};
Double_t Z_VT2[3][16968];//={0};
Double_t Z_VT3[3][16968];//={0};
Double_t Z_VT4[3][16968];//={0};
Int_t Z_SgUp1[3][16968];//={0};
Int_t Z_SgUp2[3][16968];//={0};
Int_t Z_SgUp3[3][16968];//={0};
Int_t Z_SgUp4[3][16968];//={0};
Int_t Z_SgLow1[3][16968];//={0};
Int_t Z_SgLow2[3][16968];//={0};
Int_t Z_SgLow3[3][16968];//={0};
Int_t Z_SgLow4[3][16968];//={0};
Int_t Z_NetMuon1[3][16968];//={0};
Int_t Z_NetMuon2[3][16968];//={0};
Int_t Z_NetMuon3[3][16968];//={0};
Int_t Z_NetMuon4[3][16968];//={0};

Int_t Z_AdMuon[4][3][16968];
Int_t Z_HMuonL5[4][3][16968];
Int_t Z_HMuonG5[4][3][16968];
Int_t Z_HMuonG10[4][3][16968];
Int_t Z_HMuonG15[4][3][16968];

Double_t Z_SkipTime[3][16968];//={0};
Double_t Z_LiveTime[3][16968];//={0};
Double_t Z_FullTime[3][16968];//={0};
Int_t    Z_Run[3][16968];//={0};
Int_t	 Z_BeginBin;
Int_t    Z_EndBin;
////////////////////////////////////////////////////////////////////////////////////////////////////////////
