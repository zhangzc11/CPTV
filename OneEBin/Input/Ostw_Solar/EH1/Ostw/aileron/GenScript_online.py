...
if __name__ == "__main__":
    ...
    if farm == "Tsinghua" :
        ...
        #basedir = "/work/wangzhe_work/zhangzc/Livetime/Period6AD/EH1/Ostw/aileron/"
        StreamListDir = "/back1/dayabay_back1/data/StreamList/20_P14A/"+site+"/"
        basedir = "/work/wangzhe_work/zhangzc/Ostw_Solar/EH1/Ostw/aileron/"
    else:
    ...
    for run in ListOfList:
	    ...
	    scriptDir = basedir+"Script/"+site+"/"
            ...
            cshfile = scriptDir+"run"+runN+"Z1.csh"
            print cshfile
            FILE = open(cshfile,"w")
