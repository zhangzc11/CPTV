/*
  ...
  Write function alters the format of the head line
...
class Table  {
 public:
  ...
  int Open( std::string filename )
  {
    ...
    NRows = 0;
    /// Open the file
    mTableFile.open( FileName.c_str(), ifstream::in );
  ...
  int Write( std::string filename )
  {
    ...
    /* Here, it is different from the original */
    /*
    fprintf( Outfile, "# " );
