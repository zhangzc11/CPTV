...
public:
    ...
    /// Get the cloest date in a faster way. May not be precise.
    TimeStamp    GetClosestDate()  {
      /* 2011,1,1-0:0:0 = 1293840000 */
      int nDay = int((mSec - 1293840000)/(24*60*60));
      int nSec = 1293840000 + nDay*(24*60*60);
      return TimeStamp(nSec,0);
    }
