...
void AccPerRun_EH3_AD4()
{
	...
	//Int_t Position[12]={0,2,3,4,5,6,8,25,30,31,65,73};
	//Int_t Position[12]={0,2,3,4,5,6,9,26,32,33,66,74};
	Int_t Position[12]={0,2,3,4,5,6,10,27,34,35,67,75};
	Double_t LiveTime,Rs,Rmu,Tc,Acc,E_Acc;
	Tc=200*1e-6;
	Double_t TotalAcc = 0.0;

	std::string s;
	ifstream is("../../Input/P14A_Info/eff_info_EH3.txt");
	while(!is.eof())
	{
		int startN[76]={0},endN[76]={0},pos=0,num=0;
		bool InNumber = false;
		...
		FILE* m_outfile = fopen("Acc_EH3_AD4.txt", "a");
