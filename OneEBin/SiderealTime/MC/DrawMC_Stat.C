...
void DrawMC_Stat()
{
	...
	const char* file_Name[3] = {"Simple_Shuffle_EH1_Stat.pdf","Simple_Shuffle_EH2_Stat.pdf","Simple_Shuffle_EH3_Stat.pdf"};
	const char* file_Name_2[3] = {"Simple_Shuffle_EH1_Stat.gif","Simple_Shuffle_EH2_Stat.gif","Simple_Shuffle_EH3_Stat.gif"};

	const char* c_Name_Chi[3] = {"EH1_Chi2","EH2_Chi2","EH3_Chi2"};
	const char* file_Name_Chi[3] = {"Simple_Shuffle_EH1_Chi2_Stat.pdf","Simple_Shuffle_EH2_Chi2_Stat.pdf","Simple_Shuffle_EH3_Chi2_Stat.pdf"};
	const char* file_Name_2_Chi[3] = {"Simple_Shuffle_EH1_Chi2_Stat.gif","Simple_Shuffle_EH2_Chi2_Stat.gif","Simple_Shuffle_EH3_Chi2_Stat.gif"};
	...
	for(int Hidx=0;Hidx<3;Hidx++)
	{
		...
		for(int i=4;i<90;i++)
	    {
		   my_h[idH]->SetBinContent(i,Error[Hidx][idH][i-4]);
	    }
		my_h[idH]->Draw();
		...
		for(int i=5;i<90;i++)
	    {
			my_h_Chi->SetBinContent(i,Chi2[Hidx][i-4]/(i-4.0));
		}
		my_h_Chi->Draw();
