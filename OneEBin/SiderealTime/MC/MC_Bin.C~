...
double Ma[100],Mb[100],Mf[100],Ra[100],Rb[100],Rf[100],RD_Ra[100],RD_Rb[100],RD_Rf[100];
...
void MC_Bin()
{
	...
	double Shuffle_5P_Mean[3][4][100];
	double Shuffle_5P_Sigma[3][4][100];

	double Shuffle_5P_E_Mean[3][4][100];
	double Shuffle_5P_E_Sigma[3][4][100];
	double Shuffle_5P_Chi2[3][100];

	FILE* m_outfile = fopen("MCResult.txt","a");
	FILE* m_outfile2 = fopen("MCResult_Simple.txt","a");
	///////change NumOfBin////////////////////
	for(int BinN=6; BinN<90;BinN++)
	{
		NumOfBin = BinN;
		//cout<<NumOfBin<<endl;
	...
	{
	TH1F *hist_A1 = new TH1F("hist - A1","hist - A1",50000,-1.0,1.0);
	TH1F *hist_A2 = new TH1F("hist - A2","hist - A2",50000,-1.0,1.0);
	TH1F *hist_A3 = new TH1F("hist - A3","hist - A3",50000,-1.0,1.0);
	TH1F *hist_A4 = new TH1F("hist - A4","hist - A4",50000,-1.0,1.0);


	TH1F *hist_A1_E = new TH1F("hist - A1_E","hist - A1_E",50000,-1.0,1.0);
	TH1F *hist_A2_E = new TH1F("hist - A2_E","hist - A2_E",50000,-1.0,1.0);
	TH1F *hist_A3_E = new TH1F("hist - A3_E","hist - A3_E",50000,-1.0,1.0);
	TH1F *hist_A4_E = new TH1F("hist - A4_E","hist - A4_E",50000,-1.0,1.0);

	TH1F *hist_Chi2_Sid	= new TH1F("hist - Chi2","hist - Chi2",50000,0,200.0);
	...
	for(int Bin=0;Bin<NumOfBin;Bin++)
	{
		...
		Ma[Bin] = Ma[Bin] - 
			myRandom->Gaus((TotalAcc[0]+TotalAcc[1])/NumOfBin,RD_Acc[0]*(TotalAcc[0]+TotalAcc[1])*sqrt(NumOfBin)/NumOfBin) -
			myRandom->Gaus((TotalFN[0]+TotalFN[1])/NumOfBin,RD_FN[0]*(TotalFN[0]+TotalFN[1])*sqrt(NumOfBin)/NumOfBin) -
			myRandom->Gaus((TotalLiHe[0]+TotalLiHe[1])/NumOfBin,RD_LiHe[0]*(TotalLiHe[0]+TotalLiHe[1])*sqrt(NumOfBin)/NumOfBin);
			
		Mb[Bin] = Mb[Bin] - 
			myRandom->Gaus((TotalAcc[2]+TotalAcc[3])/NumOfBin,RD_Acc[1]*(TotalAcc[2]+TotalAcc[3])*sqrt(NumOfBin)/NumOfBin) -
			myRandom->Gaus((TotalFN[2]+TotalFN[3])/NumOfBin,RD_FN[1]*(TotalFN[2]+TotalFN[3])*sqrt(NumOfBin)/NumOfBin) -
			myRandom->Gaus((TotalLiHe[2]+TotalLiHe[3])/NumOfBin,RD_LiHe[1]*(TotalLiHe[2]+TotalLiHe[3])*sqrt(NumOfBin)/NumOfBin);
		Mf[Bin] = Mf[Bin] - 
			myRandom->Gaus((TotalAcc[4]+TotalAcc[5]+TotalAcc[6]+TotalAcc[7])/NumOfBin,RD_Acc[2]*(TotalAcc[4]+TotalAcc[5]+TotalAcc[6]+TotalAcc[7])*sqrt(NumOfBin)/NumOfBin) -
			myRandom->Gaus((TotalFN[4]+TotalFN[5]+TotalFN[6]+TotalFN[7])/NumOfBin,RD_FN[2]*(TotalFN[4]+TotalFN[5]+TotalFN[6]+TotalFN[7])*sqrt(NumOfBin)/NumOfBin) -
			myRandom->Gaus((TotalLiHe[4]+TotalLiHe[5]+TotalLiHe[6]+TotalLiHe[7])/NumOfBin,RD_LiHe[2]*(TotalLiHe[4]+TotalLiHe[5]+TotalLiHe[6]+TotalLiHe[7])*sqrt(NumOfBin)/NumOfBin);
...
// Print results
   ...
   ///////////////////
    Shuffle_5P_Chi2[Hidx][BinN-6] = hist_Chi2_Sid->GetMean();

    Shuffle_5P_Mean[Hidx][0][BinN-6] = hist_A1->GetMean();
	Shuffle_5P_Mean[Hidx][1][BinN-6] = hist_A2->GetMean();
	Shuffle_5P_Mean[Hidx][2][BinN-6] = hist_A3->GetMean();
	Shuffle_5P_Mean[Hidx][3][BinN-6] = hist_A4->GetMean();

	Shuffle_5P_Sigma[Hidx][0][BinN-6] = hist_A1->GetStdDev();
	Shuffle_5P_Sigma[Hidx][1][BinN-6] = hist_A2->GetStdDev();
	Shuffle_5P_Sigma[Hidx][2][BinN-6] = hist_A3->GetStdDev();
	Shuffle_5P_Sigma[Hidx][3][BinN-6] = hist_A4->GetStdDev();

	Shuffle_5P_E_Mean[Hidx][0][BinN-6] = hist_A1_E->GetMean();
	Shuffle_5P_E_Mean[Hidx][1][BinN-6] = hist_A2_E->GetMean();
	Shuffle_5P_E_Mean[Hidx][2][BinN-6] = hist_A3_E->GetMean();
	Shuffle_5P_E_Mean[Hidx][3][BinN-6] = hist_A4_E->GetMean();

	Shuffle_5P_E_Sigma[Hidx][0][BinN-6] = hist_A1_E->GetStdDev();
	Shuffle_5P_E_Sigma[Hidx][1][BinN-6] = hist_A2_E->GetStdDev();
	Shuffle_5P_E_Sigma[Hidx][2][BinN-6] = hist_A3_E->GetStdDev();
	Shuffle_5P_E_Sigma[Hidx][3][BinN-6] = hist_A4_E->GetStdDev();
	...
	for(int Hidx=0;Hidx<3;Hidx++)
	{
		for(int i=0;i<4;i++)
		{
			fprintf(m_outfile,"%8.4f & %8.4f & %8.4f & %8.4f & %8.4f \\\\ \n", Shuffle_5P_Chi2[Hidx][BinN-6],
				Shuffle_5P_Mean[Hidx][i][BinN-6],Shuffle_5P_Sigma[Hidx][i][BinN-6],
				Shuffle_5P_E_Mean[Hidx][i][BinN-6],Shuffle_5P_E_Sigma[Hidx][i][BinN-6]);
		}
	}
	...
	//EH1
	TFile  *F_MC_data_EH1 = new TFile("MC_EH1.root","recreate");
	...
	for(int BinN=6; BinN<90;BinN++)
	{
		for(int i=0;i<4;i++)
		{
			MC_data_EH1[i] = Shuffle_5P_Sigma[0][i][BinN-6];
		}
		MC_data_EH1[4]=Shuffle_5P_Chi2[0][BinN-6];

		Tree_MC_data_EH1->Fill();
	}
	Tree_MC_data_EH1->Write();
	//EH2
	TFile  *F_MC_data_EH2 = new TFile("MC_EH2.root","recreate");
	...
	for(int BinN=6; BinN<90;BinN++)
	{
		for(int i=0;i<4;i++)
		{
			MC_data_EH2[i] = Shuffle_5P_Sigma[1][i][BinN-6];
		}
		MC_data_EH2[4]=Shuffle_5P_Chi2[1][BinN-6];

		Tree_MC_data_EH2->Fill();
	}
	Tree_MC_data_EH2->Write();
	//EH3
	TFile  *F_MC_data_EH3 = new TFile("MC_EH3.root","recreate");
	...
	for(int BinN=6; BinN<90;BinN++)
	{
		for(int i=0;i<4;i++)
		{
			MC_data_EH3[i] = Shuffle_5P_Sigma[2][i][BinN-6];
		}
		MC_data_EH3[4]=Shuffle_5P_Chi2[2][BinN-6];
