...
//	Int_t NumOfBin = (EndTime - StartTime)/WidthOfBin;//17016
	...
	const char *file_Name[8] = {
		"MuEffInOneDay_EH1_AD1.eps","MuEffInOneDay_EH1_AD2.eps","MuEffInOneDay_EH2_AD1.eps","MuEffInOneDay_EH2_AD2.eps",
		"MuEffInOneDay_EH3_AD1.eps","MuEffInOneDay_EH3_AD2.eps","MuEffInOneDay_EH3_AD3.eps","MuEffInOneDay_EH3_AD4.eps"};
	TCanvas *myC[8];
	TH1F *my_h[8];
	TLegend *leg[8];
	for(int Det=0;Det<8;Det++)
	...
	//my_h[Det]->GetYaxis()->SetTitle("Ad Muon Rate (/day)");
		if(Det==4)
		{
	my_h[Det]->GetYaxis()->SetRangeUser(0.98425,0.98475);
		}
