...
//	Int_t NumOfBin = (EndTime - StartTime)/WidthOfBin;//17016
	...
	const char *file_Name[8] = {
		"AmCRate_EH1_AD1.eps","AmCRate_EH1_AD2.eps","AmCRate_EH2_AD1.eps","AmCRate_EH2_AD2.eps",
		"AmCRate_EH3_AD1.eps","AmCRate_EH3_AD2.eps","AmCRate_EH3_AD3.eps","AmCRate_EH3_AD4.eps"};
	TCanvas *myC[8];
	TH1F *my_h[8];
	TLegend *leg[8];
	for(int Det=0;Det<8;Det++)
	...
	if(Det==4)
		{
	my_h[Det]->GetYaxis()->SetRangeUser(0.10,0.125);
		}
