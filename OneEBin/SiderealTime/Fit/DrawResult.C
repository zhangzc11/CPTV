...
void DrawResult()
{
	...
	gr_DC->GetYaxis()->SetTitle("Data/Expectation");
	//gr_DC->GetYaxis()->SetRangeUser(0.90,1.00);
	gr_DC->GetYaxis()->SetRangeUser(0.7,1.1);
	gr_DC->SetTitle("");

	gr_DC->GetYaxis()->SetTitleOffset(0.5);
	...
	gr_DC->GetXaxis()->SetTitleOffset(0.6);
	gr_DC->GetXaxis()->SetTitleSize(0.07);
	gr_DC->GetXaxis()->SetLabelSize(0.05);
   ...
   leg_DC->AddEntry(gr_DC,"Daya Bay - EH3","");
