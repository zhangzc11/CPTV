...
//cout<<"line 378...."<<endl;
	...
	leg2->AddEntry(gr3,"EH1-Only IBD candidate considered, flux = const","lP");
	 leg2->AddEntry(gr2,"EH1-Only IBD candidate considered, flux = flux(t)","lP");
   leg2->AddEntry(gr1,"EH1-With bkg., efficiency etc. correction","lP");
   leg2->SetFillStyle(0);
   ...
   leg2->Draw();
	...
	gPad->Modified();
   myC1->SaveAs("Ratio_EH1_OneDay_sidereal_const_Compare.pdf");
