...
void FastN()
{
	...
	for(int Det=0;Det<8;Det++)
	{
		...
		{
			FastNInOneDay[Det][N24] = TotalFastN[Det] * HMuG15InOneDay[Det][N24]/TotalHMuG15[Det];
			RD_FastNInOneDay[Det][N24] = sqrt(1.0/HMuG15InOneDay[Det][N24] - 1.0/TotalHMuG15[Det]);
		}
	}
	...
	for(int Det=0;Det<8;Det++)
	{
	   ...
	   Double_t MaxR=0.0,MeanR=0.0,MinR=86400.0*FastNInOneDay[Det][0]/FullTimeInOneDay[Det][0],MaxE=0.0;
		...
		cout<<"Total FastN of "<<hist_Name[Det]<<TotalFastN[Det]<<endl;
