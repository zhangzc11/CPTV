...
void AccDistr_EH3_AD3()
{
	...
	TFile  *NumOfAccF = new TFile("NumOfAccInEachBin_EH3_AD3.root","recreate");
	...
	TFile  *E2_NumOfAccF = new TFile("E2_NumOfAccInEachBin_EH3_AD3.root","recreate");
	...
	TFile  *NumOfAccF2 = new TFile("NumOfAccInOneDay_EH3_AD3.root","recreate");
	...
	NumOfAccTree2->Write();
	NumOfAccF2->Close();
	cout<<"Total NumOfAcc in EH3_AD3: "<<TotalAcc<<endl;
	...
	TFile  *E2_NumOfAccF2 = new TFile("E2_NumOfAccInOneDay_EH3_AD3.root","recreate");
	...
	t_Acc->SetTitle("NumOfAcc - EH3_AD3");
    ...
    t_Acc->Draw();
	C_Acc2->SaveAs("NumOfAccInOneDay_EH3_AD3.gif");
	/////////////////////////////////////////////////////////////////////////////////////////////
