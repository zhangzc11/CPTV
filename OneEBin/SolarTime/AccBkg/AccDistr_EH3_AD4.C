...
void AccDistr_EH3_AD4()
{
	...
	const Int_t NumOfInfoLine = 13903;
	...
	TFile  *NumOfAccF = new TFile("NumOfAccInEachBin_EH3_AD4.root","recreate");
	...
	TFile  *E2_NumOfAccF = new TFile("E2_NumOfAccInEachBin_EH3_AD4.root","recreate");
	...
	TFile  *NumOfAccF2 = new TFile("NumOfAccInOneDay_EH3_AD4.root","recreate");
	...
	NumOfAccTree2->Write();
	NumOfAccF2->Close();
	cout<<"Total NumOfAcc in EH3_AD4: "<<TotalAcc<<endl;

	////////////////////////////E2
	Int_t E2_NumOf24Acc[24]={0};
	Double_t E2_OneDay[24] = {0.0};
	Double_t E2_NumOfAccInOneDay;
	TFile  *E2_NumOfAccF2 = new TFile("E2_NumOfAccInOneDay_EH3_AD4.root","recreate");
	...
	t_Acc->SetTitle("NumOfAcc - EH3_AD4");
    ...
    t_Acc->Draw();
	C_Acc2->SaveAs("NumOfAccInOneDay_EH3_AD4.gif");
	/////////////////////////////////////////////////////////////////////////////////////////////
