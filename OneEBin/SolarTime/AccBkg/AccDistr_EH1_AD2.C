...
void AccDistr_EH1_AD2()
{
	...
	Int_t ADNo = 1;
	Int_t AD_index = 1;
	const Int_t NumOfRun = 371;
	const Int_t NumOfInfoLine = 13946;
	...
	std::string s2;
	ifstream is2("../InfoInEachBin_EH1.txt");
	...
	TFile  *NumOfAccF = new TFile("NumOfAccInEachBin_EH1_AD2.root","recreate");
	...
	TFile  *E2_NumOfAccF = new TFile("E2_NumOfAccInEachBin_EH1_AD2.root","recreate");
	...
	TFile  *NumOfAccF2 = new TFile("NumOfAccInOneDay_EH1_AD2.root","recreate");
	...
	NumOfAccTree2->Write();
	NumOfAccF2->Close();
	cout<<"Total NumOfAcc in EH1_AD2: "<<TotalAcc<<endl;

	////////////////////////////E2
	Int_t E2_NumOf24Acc[24]={0};
	Double_t E2_OneDay[24] = {0.0};
	Double_t E2_NumOfAccInOneDay;
	TFile  *E2_NumOfAccF2 = new TFile("E2_NumOfAccInOneDay_EH1_AD2.root","recreate");
	...
	t_Acc->SetTitle("NumOfAcc - EH1_AD2");
    ...
    t_Acc->Draw();
	C_Acc2->SaveAs("NumOfAccInOneDay_EH1_AD2.gif");
	/////////////////////////////////////////////////////////////////////////////////////////////
