...
void Flux()
{
	...
	// save to .root filelength

	double PredRate[8];
	TFile  *F_PredRate = new TFile("PredRate.root","recreate");
	TTree *Tree_PredRate = new TTree("PredRate","PredRate");

	Tree_PredRate->Branch("PredRate",PredRate,"PredRate[8]/D");
   ...
   leg2->Draw();
	...
	c2->SaveAs("Flux_AD_interpolation.jpg");
