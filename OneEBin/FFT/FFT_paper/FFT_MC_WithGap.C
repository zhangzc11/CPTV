...
//	//cout<<"...................."<<mean_an[0][0]<<"  "<<sigma_an[0][0]<<endl;
  ...
  //Draw, Rt
	...
	const char* file_Name_Rt[3] = {"EH1_Rt_WithGap.eps","EH2_Rt_WithGap.eps","EH3_Rt_WithGap.eps"};
	TCanvas *myC_Rt[3];
...
//Draw, _abn
	...
	const char* file_Name_abn[3] = {"EH1_abn_MC_WithGap.eps","EH2_abn_MC_WithGap.eps","EH3_abn_MC_WithGap.eps"};
	TCanvas *myC_abn[3];
