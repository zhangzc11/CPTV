...
const int NumOfBin_Day = 24;

double RD_R_data[3][24]={{0.0}};
////////SYS
double RD_Acc[8] = {0.008/4.9,0.008/4.9,0.01/4.9,0.01/4.9,0.02/4.9,0.02/4.9,0.02/4.9,0.02/4.9};
double RD_FN[8] = {0.0002/4.9,0.0002/4.9,0.0002/4.9,0.0002/4.9,0.001/4.9,0.001/4.9,0.001/4.9,0.001/4.9};
double RD_Li9[8] = {0.0002/4.9,0.0002/4.9,0.0002/4.9,0.0002/4.9,0.001/4.9};
