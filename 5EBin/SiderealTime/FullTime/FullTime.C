...
void FullTime()
{
	...
	const char *file_Name[8] = {
		"FullTimeInOneDay_EH1_AD1.pdf","FullTimeInOneDay_EH1_AD2.pdf","FullTimeInOneDay_EH2_AD1.pdf","FullTimeInOneDay_EH2_AD2.pdf",
		"FullTimeInOneDay_EH3_AD1.pdf","FullTimeInOneDay_EH3_AD2.pdf","FullTimeInOneDay_EH3_AD3.pdf","FullTimeInOneDay_EH3_AD4.pdf"};
	TCanvas *myC[8];
	TH1F *my_h[8];
	TLegend *leg[8];
	for(int Det=0;Det<8;Det++)
