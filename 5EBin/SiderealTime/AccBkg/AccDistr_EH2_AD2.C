...
void AccDistr_EH2_AD2()
{
	...
	const Int_t NumOfInfoLine = 14058;
	...
	TFile  *NumOfAccF = new TFile("NumOfAccInEachBin_EH2_AD2.root","recreate");
	...
	TFile  *E2_NumOfAccF = new TFile("E2_NumOfAccInEachBin_EH2_AD2.root","recreate");
	...
	TFile  *NumOfAccF2 = new TFile("NumOfAccInOneDay_EH2_AD2.root","recreate");
	...
	NumOfAccTree2->Write();
	NumOfAccF2->Close();
	cout<<"Total NumOfAcc in EH2_AD2: "<<TotalAcc<<endl;

	////////////////////////////E2
	Int_t E2_NumOf24Acc[24]={0};
	Double_t E2_OneDay[24] = {0.0};
	Double_t E2_NumOfAccInOneDay;
	TFile  *E2_NumOfAccF2 = new TFile("E2_NumOfAccInOneDay_EH2_AD2.root","recreate");
	...
	t_Acc->SetTitle("NumOfAcc - EH2_AD2");
    ...
    t_Acc->Draw();
	C_Acc2->SaveAs("NumOfAccInOneDay_EH2_AD2.gif");
	/////////////////////////////////////////////////////////////////////////////////////////////
